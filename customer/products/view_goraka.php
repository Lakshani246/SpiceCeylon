...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Goraka%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Goraka product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Goraka.jpg';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> GOR-016</p>
        <p><strong>Category:</strong> Specialty & Regional Spices</p>
        <p><strong>Taste Profile:</strong> Sour & Tangy</p>
