...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Garlic%' OR name LIKE '%Sudu Lunu%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Garlic product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Garlic1.jpg';
...
$spice_sinhala = 'Sudu Lunu - සුදු ලූනු';
