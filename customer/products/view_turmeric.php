...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Turmeric%' OR name LIKE '%Kaha%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Turmeric product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Turmeric1.jpg';
