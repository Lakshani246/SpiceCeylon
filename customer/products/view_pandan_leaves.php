...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Pandan Leaves%' OR name LIKE '%Rampe%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Pandan Leaves product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Pandan-Leaves1.jpg';
