...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Curry Leaves%' OR name LIKE '%Karapincha%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Curry Leaves product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Curry-Leaves1.jpg';
...
$default_price = $prices['50g'];
$spice_sinhala = 'Karapincha - කරපිංචා';
