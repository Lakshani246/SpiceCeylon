...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Licorice Powder%' OR name LIKE '%Welmi%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Licorice Powder product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Licorice-Powder1.jpg';
...
$spice_sinhala = 'Welmi Kudu - වැල්මී කුඩු';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> LIC-018</p>
        <p><strong>Category:</strong> Medicinal & Herbal Spices</p>
        <p><strong>Taste Profile:</strong> Sweet & Earthy</p>
