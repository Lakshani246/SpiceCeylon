...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Cumin Seeds%' OR name LIKE '%Suduru%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Cumin Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Cumin-Seeds1.jpg';
