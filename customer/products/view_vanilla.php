...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Vanilla%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Vanilla product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Vanilla1.jpg';
...
$default_price = $prices['5 Beans'];
$spice_sinhala = 'Vanila - වැනිලා';
