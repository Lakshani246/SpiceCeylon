...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> SWF-023</p>
        <p><strong>Category:</strong> Medicinal & Ayurvedic Herbs</p>
        <p><strong>Aroma Profile:</strong> Spicy & Camphor-like</p>
        <p><strong>Traditional Uses:</strong> Ayurvedic medicine, Religious rituals, Memory enhancement</p>
