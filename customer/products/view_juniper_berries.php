...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Juniper Berries%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Juniper Berries product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Juniper-Berries1.jpg';
