...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Cloves%' OR name LIKE '%Karabu%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Cloves product not found in database! Please check products table.");
}
...
$default_price = $prices['25g'];
$spice_sinhala = 'Karabu Nati - කරාබු නැටි';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> CLO-029</p>
        <p><strong>Category:</strong> Premium Ceylon Spices</p>
        <p><strong>Flavor Profile:</strong> Intense, Sweet & Pungent</p>
        <p><strong>Best For:</strong> Curries, Rice dishes, Mulled wine, Baking</p>
