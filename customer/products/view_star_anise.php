...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Star Anise%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Star Anise product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Star-anise1.jpg';
...
$spice_sinhala = 'Kaha Kudu - කහ කුඩු';
