...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Black Pepper%' OR name LIKE '%Gammiris%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Black Pepper product not found in database! Please check products table.");
}
