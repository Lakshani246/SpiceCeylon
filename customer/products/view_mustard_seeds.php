...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Mustard Seeds%' OR name LIKE '%Abaa%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Mustard Seeds product not found in database! Please check products table.");
}
