...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Screw Pine%' OR name LIKE '%Kewra%' OR name LIKE '%Wathakesi%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Screw Pine product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Screw-Pine-Kewra.jpg';
...
$default_price = $prices['25 leaves'];
$spice_sinhala = 'Wathakesi - වතකෙසි';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> SCR-020</p>
        <p><strong>Category:</strong> Aromatic Essences & Flavorings</p>
        <p><strong>Aroma Profile:</strong> Floral & Sweet</p>
        <p><strong>Common Uses:</strong> Desserts, Biryanis, Traditional Sweets</p>
