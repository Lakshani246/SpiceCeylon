...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Dill%' OR name LIKE '%Endaru%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Dill product not found in database! Please check products table.");
}
