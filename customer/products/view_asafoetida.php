...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Asafoetida%' OR name LIKE '%Perungayam%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Asafoetida product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Asafoetida1.jpg';
...
$spice_sinhala = 'Perungayam - පෙරුන්ගායම්';
