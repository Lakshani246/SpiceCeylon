...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Lemongrass%' OR name LIKE '%Sera%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Lemongrass product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Lemongrass1.jpg';
...
$default_price = $prices['5 stalks'];
$spice_sinhala = 'Sera - සේර';
