...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Coriander Seeds%' OR name LIKE '%Kottamalli%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Coriander Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Coriander-Seeds1.jpg';
...
$spice_sinhala = 'Kottamalli - කොත්තමල්ලි';
