...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Fennel Seeds%' OR name LIKE '%Maduru%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Fennel Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Fennel-Seeds1.jpg';
