...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Fenugreek Seeds%' OR name LIKE '%Uluhaal%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Fenugreek Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Fenugreek-Seeds1.jpg';
