...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Caraway Seeds%' OR name LIKE '%Kala Jeera%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Caraway Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Caraway-Seeds1.jpg';
...
$spice_sinhala = 'Kala Jeera - කලා ජීර';
