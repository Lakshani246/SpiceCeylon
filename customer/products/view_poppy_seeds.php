...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Poppy Seeds%' OR name LIKE '%Gas Kasa%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Poppy Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Poppy-seeds1.jpg';
...
$spice_sinhala = 'Gas Kasa - ගස් කාසා';
