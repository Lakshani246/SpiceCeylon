...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Nutmeg%' OR name LIKE '%Mace%' OR name LIKE '%Sadikka%' OR name LIKE '%Wasawasee%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Nutmeg & Mace product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Nutmeg-&-Mace1.jpg';
...
$prices = [
    ...
    '10g Mace'       => 120,
    '25g Mace'       => 280,
    '25g Nutmeg Powder' => 180,
    '50g Nutmeg Powder' => 320
];

$default_price = $prices['5 Whole Nutmeg'];
$spice_sinhala = 'Sadikka / Wasawasee - සාදික්කා / වසාවාසි';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> NUM-030</p>
        <p><strong>Category:</strong> Premium Ceylon Spices</p>
        <p><strong>Nutmeg Flavor:</strong> Warm, Nutty & Sweet</p>
        <p><strong>Mace Flavor:</strong> Delicate, Aromatic & Citrusy</p>
        <p><strong>Best For:</strong> Curries, Desserts, Beverages, Baking, White sauces</p>
        <p><strong>Storage Tip:</strong> Store in airtight container away from light</p>
