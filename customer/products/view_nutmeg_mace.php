...
$spice_desc = 'Nutmeg and Mace are spices from the same plant. Nutmeg is aromatic and warm, while Mace has a delicate flavor.';
...
<style>
/* === Global & Header/Body Styles (same as Cinnamon page) === */
