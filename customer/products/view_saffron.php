...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Saffron%' OR name LIKE '%Kunkuma%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Saffron product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Saffron1.jpg';
...
$default_price = $prices['1g'];
$spice_sinhala = 'Kunkuma - කුංකුම';
