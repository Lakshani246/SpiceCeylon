...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Sumac%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Sumac product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Sumac1.jpg';
