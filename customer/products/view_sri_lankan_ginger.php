...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Sri Lankan Ginger%' OR name LIKE '%Inguru%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Sri Lankan Ginger product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Sri-Lankan-Ginger1.jpg';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> GIN-010</p>
        <p><strong>Category:</strong> Fresh Roots & Bulbs</p>
