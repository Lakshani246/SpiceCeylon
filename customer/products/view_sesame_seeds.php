...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Sesame Seeds%' OR name LIKE '%Tala%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Sesame Seeds product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Sesame-Seeds1.jpg';
