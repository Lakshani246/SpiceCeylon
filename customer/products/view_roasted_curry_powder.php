...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Roasted Curry Powder%' OR name LIKE '%Badapu Thunapaha%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Roasted Curry Powder product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Roasted-Curry-Powder1.jpg';
...
$spice_sinhala = 'Badapu Thunapaha Kudu - බැදපු ‌තුනපහ කුඩු';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> RCP-024</p>
        <p><strong>Category:</strong> Spice Blends</p>
        <p><strong>Flavor Profile:</strong> Rich, Smoky & Aromatic</p>
        <p><strong>Best For:</strong> Meat curries, Potato dishes, Lentil curries</p>
