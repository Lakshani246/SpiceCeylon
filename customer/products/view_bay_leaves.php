...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Bay Leaves%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Bay Leaves product not found in database! Please check products table.");
}
...
$spice_image = '../../assets/images/Bay-Leaves1.jpg';
...
$spice_sinhala = 'Bae Kolaya - බේ කොළ';
