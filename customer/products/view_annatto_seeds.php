...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Annatto%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Annatto Seeds product not found in database!");
}
...
$spice_image = '../../assets/images/Annatto-Seeds1.jpg'; // Your detailed view image
...
$spice_sinhala = 'Kaha Kudu Beeja - කහ කුඩු බීජ';
...
<form method="POST" action="../add_to_cart.php">
    ...
    <div class="product-meta">
        <p><strong>SKU:</strong> ANN-019</p>
        <p><strong>Category:</strong> Natural Colorants & Specialty</p>
        <p><strong>Primary Use:</strong> Natural Food Coloring</p>
