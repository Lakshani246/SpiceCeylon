...
$product_query = mysqli_query($conn, "SELECT * FROM products WHERE name LIKE '%Tamarind%' OR name LIKE '%Siyambala%' LIMIT 1");
$product = mysqli_fetch_assoc($product_query);

if (!$product) {
    die("Tamarind product not found in database! Please check products table.");
}
